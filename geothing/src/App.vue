  ...
  fetch(
    ...
    .then(() => {
      ...
      bars.forEach((bar) => {
        ...
        if (bar.id === "trade") {
          percent =
            100 * (econData.value.exports / (econData.value.imports * 2));
        }
        if (bar.id === "safety") {
        ...
        if (bar.id === "modernization") {
          percent =
            ...
            (econData.value.urban_population / 100 / 2 +
              econData.value.employment_services / 100 / 2);
        }
...
onMounted(() => {
  ...
  bars.forEach((bar) => {
    ...
    if (bar.id === "trade") {
      percent = 100 * (econData.value.exports / (econData.value.imports * 2));
    }
    if (bar.id === "safety") {
      percent = 100 - 100 * (econData.value.homicide_rate / 53);
    }
          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-6 py-4">
                  ${{ numberWithCommas(econData.gdp * 1000000) || "N/A" }}
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              ...
              >
                ...
                <td class="px-6 py-4">
                  ${{ numberWithCommas(econData.gdp_per_capita) || "N/A" }}
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">
                  ${{ numberWithCommas(econData.exports * 1000000) || "N/A" }}
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">
                  ${{ numberWithCommas(econData.imports * 1000000) || "N/A" }}
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">{{ econData.unemployment || "N/A" }}%</td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">
                  {{
                    numberWithCommas(econData.co2_emissions * 1000000) || "N/A"
                  }}
                  mt
                </td>
              </tr>
          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-6 py-4">
                  {{ numberWithCommas(econData.population * 1000) || "N/A" }}
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">
                  {{ econData.life_expectancy_male || "N/A" }} Years
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">
                  {{ econData.life_expectancy_female || "N/A" }} Years
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              ...
              >
                ...
                <td class="px-6 py-4">
                  {{ econData.homicide_rate || "N/A" }} Per 100,000
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              ...
              >
                ...
                <td class="px-6 py-4">
                  {{ econData.pop_density || "N/A" }} Per km<sup>2</sup>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-6 py-4">
                  <div class="myProgress bg-gray-50">
                    <div class="myBar" id="life_expectancy"></div>
                  </div>
                </td>
              </tr>
              <tr
              ...
              >
                ...
                <td class="px-6 py-4">
                  <div class="myProgress bg-gray-50">
                    <div class="myBar" id="modernization"></div>
                  </div>
                </td>
              </tr>
              <tr
              ...
              >
                ...
                <td class="px-6 py-4">
                  <div class="myProgress bg-gray-50">
                    <div class="myBar" id="co2_emissions"></div>
                  </div>
                </td>
              </tr>
            </tbody>
