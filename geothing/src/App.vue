          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-6 py-4">{{ econData.gdp_growth }}% Per Year</td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">
                  ${{ numberWithCommas(econData.gdp_per_capita) }}
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">
                  ${{ numberWithCommas(econData.exports * 1000000) }}
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">
                  ${{ numberWithCommas(econData.imports * 1000000) }}
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">{{ econData.unemployment }}%</td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">
                  {{ numberWithCommas(econData.co2_emissions * 1000000) }}
                  metric tons
                </td>
              </tr>
              <tr
              ...
              >
                ...
                <td class="px-6 py-4">{{ econData.internet_users }}%</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-6 py-4">
                  {{ numberWithCommas(econData.population * 1000) }}
                </td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              ...
              >
                ...
                <td class="px-6 py-4">{{ econData.fertility }} Per Couple</td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">{{ econData.infant_mortality }}%</td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">{{ econData.homicide_rate }}%</td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">{{ econData.urban_population }}%</td>
              </tr>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
              >
                ...
                <td class="px-6 py-4">
                  {{ econData.pop_density }} per km<sup>2</sup>
                </td>
              </tr>
            </tbody>
          </table>
